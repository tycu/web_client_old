...
var rePath = RegExp(normalize('lodash(?:/(?!fp/)|-es/|-amd/)'));
    ...
    value: function apply(compiler) {
      ...
      var resolvePath = _lodash2.default.memoize(function (_ref) {
        ...
        _lodash2.default.each(_this.patterns, function (pair) {
          ...
          if (_path2.default.basename(resource, '.js') != pair[0] || reRequest.test(rawRequest) && _lodash2.default.includes(_listing.stubs, pair[1])) {
            return;
          }
          var modulePath = _path2.default.join(_path2.default.dirname(resource), pair[1] + '.js');
