...
var ModuleCache = function (_MapCache) {
  ...
  function ModuleCache(moduleRoot) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ModuleCache).call(this));

    moduleRoot = (0, _toString3.default)(moduleRoot);
    var dirPaths = moduleRoot ? _glob2.default.sync(_path2.default.join(moduleRoot, '**/')) : [];
