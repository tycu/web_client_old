...
var Store = function (_MapCache) {
  ...
  _createClass(Store, [{
    ...
    value: function get(pkgPath) {
      return _get(Object.getPrototypeOf(Store.prototype), 'get', this).call(this, normalize(pkgPath));
    }
  }, {
    key: 'set',
    value: function set(pkgPath) {
      var pkgStore = arguments.length <= 1 || arguments[1] === undefined ? new _Package2.default(normalize(pkgPath)) : arguments[1];

      return _get(Object.getPrototypeOf(Store.prototype), 'set', this).call(this, normalize(pkgPath), pkgStore);
    }
  }]);
