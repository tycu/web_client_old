...
function lodash(_ref) {
  ...
  var visitor = {
    Program: function Program(path, state) {
      ...
      var ids = _assign2.ids;

      var file = path.hub.file;

      if ((0, _isEmpty3.default)(ids)) {
        ...
        (0, _each3.default)(specs, function (spec) {
          ...
          (0, _each3.default)(binding.referencePaths, function (refPath) {
            ...
            if (imported && imported != 'default') {
              ...
              var name = _importModule.name;

              refPath.replaceWith({ type: type, name: name });
              ...
              var _name = _importModule2.name;

              parentPath.replaceWith({ type: type, name: _name });
            } else if (isLodash) {
